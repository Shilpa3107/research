    ...
    <div class="flex justify-center p-2 m-5">
        <div class="table-responsive p-2 rounded-md">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<th class="px-4 py-2">Impact Factor</th>';
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="border px-4 py-2 text-center">
                            <a href="editReoResearchpaper.php?id=' . $row['user_id'] . '" class="btn-icon edit">
                    ...
                    echo '<td class="border px-4 py-2">' . $row['impact'] . '</td>';
                    ...
                    echo '<td class="border px-4 py-2">' . $row['link'] . '</td>';
