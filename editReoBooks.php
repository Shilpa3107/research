...
//cheking if dir. to store files is available if not it is being created
    ...
    if ($conn->query($sql) === TRUE) {
	    ...
	    echo "location.replace('editReoBooks.php?id=".$id."')";
	    echo "</script>";
        exit();
    } else {
	...
	<form class="space-y-6" method="post" action="books.php" enctype="multipart/form-data">
		...
		<div id="section1" class="form-section active ">
			...
			<div class="my-10">
				...
				<input type="text" name="paper_title" id="paper_title" value="<?php echo $row['booktitle']; ?>" placeholder="Enter Title of Book" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
			...
			<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
					...
					<div class="mb-4">
						...
						<div class="flex items-center space-x-4">
							<label class="inline-flex items-center">
								<input name="peer" <?php if($row['peer'] == 'y') echo 'checked'; ?> type="radio" class="form-radio text-blue-500" value="y" />
								<span class="ml-2 mr-2">Yes</span>
							</label>
							<label class="inline-flex items-center">
								<input name="peer" <?php if($row['peer'] == 'n') echo 'checked'; ?> type="radio" class="form-radio text-blue-500" value="n" />
				...
				<div>
					<div class="mb-4">
						...
						<div class="flex items-center space-x-4">
							<label class="inline-flex items-center">
								<input name="scopus" <?php if($row['scopus'] == 'y') echo 'checked'; ?> type="radio" class="form-radio text-blue-500" value="y" />
								<span class="ml-2 mr-2">Yes</span>
							</label>
							<label class="inline-flex items-center">
								<input name="scopus" <?php if($row['scopus'] == 'n') echo 'checked'; ?> type="radio" class="form-radio text-blue-500" value="n" />
								<span class="ml-2 mr-2">No</span>
							</label>
						</div>
					</div>
				...
				<div>
					<div class="mb-4">
						...
						<div class="flex items-center space-x-4">
							<label class="inline-flex items-center">
								<input name="wos" <?php if($row['wos'] == 'y') echo 'checked'; ?> type="radio" class="form-radio text-blue-500" value="y" />
								<span class="ml-2 mr-2">Yes</span>
							</label>
							<label class="inline-flex items-center">
								<input name="wos" <?php if($row['wos'] == 'n') echo 'checked'; ?> type="radio" class="form-radio text-blue-500" value="n" />
								<span class="ml-2 mr-2">No</span>
							</label>
						</div>
					</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div class="mb-6">
					...
					<div class="flex items-center">
						<input class="form-control date-picker w-full max-w-md px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" id="publicationdate" name="publicationdate" value="<?php echo $row['pubdate']; ?>" type="date" data-date-format="yyyy-mm-dd" />
					</div>
				</div>
				<div class="mb-6">
