            ...
            <div class="flex justify-between h-14">
                <div class="flex">
                    <a href="index1.php" class="flex items-center">
                        ...
                        <span class="ml-3 text-3xl font-serif text-grey-500">Amity University Patna</span>
                    </a>
                </div>
                <div class="flex items-center">
                    ...
                    <ul class="flex space-x-4">
                        <li class="nav-item">
                            <a href="index1.php" class="px-4 py-2 text-lg font-thin hover:bg-gradient-to-b from-blue-200 to-blue-50 rounded-lg flex items-center">
                                <i class="fa fa-home mr-2"></i> Home
                            </a>
                        </li>
                        <li class="nav-item relative">
                            <a href="#" class="px-4 py-2 hover:bg-gradient-to-b text-lg font-thin from-blue-200 to-blue-50 rounded-lg flex items-center">
