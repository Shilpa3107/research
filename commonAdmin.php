                ...
                <div class="flex justify-between h-14">
                    <div class="flex">
                        <a href="index1admin.php" class="flex items-center">
                            ...
                            <span class="ml-3 text-3xl font-serif text-gray-100">Amity University Patna</span>
                        </a>
                    </div>
                    ...
                    <ul class="flex space-x-4">
                        <li class="nav-item">
                            <a href="index1admin.php" class="px-4 py-2 text-gray-100 text-lg font-thin hover:bg-gradient-to-b from-purple-900 to-purple-600 rounded-lg flex items-center">
                                <i class="fa fa-home mr-2"></i> Home
                            </a>
                        </li>
                        <li class="nav-item relative">
                            <a href="#" class="px-4 py-2 text-gray-100 text-lg font-thin hover:bg-gradient-to-b from-purple-900 to-purple-600 rounded-lg flex items-center">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden" x-cloak>
                            ...
                            <a href="logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200">Logout</a>
                        </div>
                    </div>
                        </li>
                    </ul> 
