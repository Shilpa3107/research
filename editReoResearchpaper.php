...
//cheking if dir. to store files is available if not it is being created
    ...
    if ($conn->query($sql) === TRUE) {
	    ...
	    echo "location.replace('editReoResearchpaper.php?id=".$id."')";
	    echo "</script>";
	...
	<form class="space-y-6" method="post" action="ResearchPaper.php" enctype="multipart/form-data">
		...
		<div id="section1" class="form-section active ">
			...
			<div class="my-10">
				...
				<input type="text" name="paper_title" id="paper-title"value="<?php echo $row['papertitle']; ?>" placeholder="Enter Title of Paper" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
		...
		<div id="section2" class="form-section">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
				...
				<div class="mb-4">
					...
					<input type="text" name="article" id="research-paper" value="<?php echo $row['article']; ?>" placeholder="Enter Research Paper/Article" class="mt-1 w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
								...
								<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
									<div class="mb-6">
										...
										<div class="flex items-center">
											<input class="form-control date-picker w-full max-w-md px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" id="publication-date" value="<?php echo $row['pubdate']; ?>" name="publicationdate" type="date" data-date-format="yyyy-mm-dd" />
										</div>
									</div>
									<div class="mb-6">
										<label for="publication-year" class="block text-gray-700 font-semibold mb-2">Publication Year</label>
										<input class="w-full max-w-md px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="number" id="publication-year" value="<?php echo $row['pubyear']; ?>" name="pubyear" placeholder="Enter Publication Year" />
									</div>
									<div>
