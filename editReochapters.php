...
//cheking if dir. to store files is available if not it is being created
    ...
    if ($conn->query($sql) === TRUE) {
       ...
       echo "<script>";
	    ...
	    echo "location.replace('editReochapters.php?id=".$id."')";
	    echo "</script>";
...
if (isset($_GET['id']) && !empty(trim($_GET['id']))) {
    ...
    $sql = "SELECT * FROM bookchaptersbyfaculty WHERE user_id = ?";
	...
	<form class="space-y-6" method="post" action="Chapters.php" enctype="multipart/form-data">
		...
		<div id="section1" class="form-section active ">
			...
			<div class="my-10">
				...
				<input type="text" name="paper_title" id="paper-title" value="<?php echo $row['booktitle']; ?>" placeholder="Enter Title of Chapter"  class="mt-1 w-full max-w-md px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
